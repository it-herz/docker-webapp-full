...
RUN  apt-get update && \
     rm /tmp/*.deb && cd /tmp && \
     wget http://ftp.ru.debian.org/debian/pool/main/n/ncurses/libncurses5_6.0+20160625-1_amd64.deb && \
     wget http://ftp.ru.debian.org/debian/pool/main/n/ncurses/libncursesw5_6.0+20160625-1_amd64.deb && \
     dpkg -i *.deb && \
